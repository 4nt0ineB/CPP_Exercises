...
{
    auto it_animal = std::find_if(animals.begin(), animals.end(), [species](const Animal& animal) { return animal.species == species; });
    return std::distance(animals.begin(), it_animal);
}
